...
class ContactHelper {
  ...
  Future<List> getAllContacts() async {
    ...
    List<Contact> listContact =  []; //List() vscode solicitou como sugestão para passar uma array vazia que seria o mesmo que usar o List();
...
class Contact{
  ...
  @override
  String toString() {
    return "Contact(id: $id, name: $name, email: $email, phone: $email, img: $img)";
  }
